            ...
            >
              ...
              {plan.badge && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                  <span className="inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-yellow-400 to-orange-500 px-4 py-1 text-sm font-semibold text-white shadow-lg">
              ...
              <a
                href={plan.ctaLink}
                className={`mt-8 block w-full rounded-full py-3 px-6 text-center text-sm font-semibold transition-all ${
                  plan.highlighted
              ...
              <ul className="mt-8 space-y-3">
                {plan.features.map((feature) => (
                  <li key={feature} className="flex items-start gap-3">
                    <Check className={`h-5 w-5 flex-shrink-0 ${plan.highlighted ? 'text-white' : 'text-blue-600'}`} />
